...
# Set up
# setwd('/Users/ssmeele/ownCloud/Simeon/MPI AB/PhD thesis/Chapter IV/Coevolution_of_brain_size_and_longevity_in_parrots_supports_the_cognitive_buffer_hypothesis/ANALYSIS/CODE/markdowns')
...
slope_1 = mean(sapply(1:length(post$b_brain_life), function(i) post$b_brain_life[i] * sd_rel_brain[i])) %>% round(2) %>% formatC(format = 'f', flag='0', digits = 2)
...
slope_2 = mean(sapply(1:length(post$b_brain_life), function(i) post$b_brain_life[i] * sd_rel_brain[i])) %>% round(2)
...
slope_3 = mean(sapply(1:length(post$b_brain_life), function(i) post$b_brain_life[i] * sd_rel_brain[i])) %>% round(2)
```
\
